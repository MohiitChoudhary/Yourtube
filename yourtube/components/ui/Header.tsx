              ...
              <DropdownMenuTrigger asChild>
                ...
                >
                  <Avatar className="h-8 w-8">
                    ...
                    <AvatarFallback>{user.channelname?.[0] || "U"}</AvatarFallback>
                  </Avatar>
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                <div className="px-2 py-1">
                  <button
                    ...
                    type="button"
                    className="w-full px-2 py-1.5 text-sm text-left rounded hover:bg-gray-100 cursor-pointer transition-colors"
                  >
                    Sign out
                  </button>
                </div>
